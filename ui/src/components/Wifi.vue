<template>
  <div class="container" id="wifi-box">
    ...
    <h3>Optional parameters
      <span class="blink-text" v-if="Object.keys(optionList).length === 0 && optionList.constructor === Object">  ...loading</span>
    </h3>
    ...
    <div style="margin: auto auto;">
      <button type="button" class="btn btn-primary sm" @click="saveConfig" >Save setup configuration - {{espHostame}}</button>
    </div>
