...
const char* client_id     =  "xxxxxxxxxxxxxx-xxxxxxxxxxxxxxxxxxxxxxxxxxxx.apps.googleusercontent.com";
const char* client_secret =  "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
const char* api_key       =  "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
